...
namespace Com.Grooveip.Sdk.Api
{
    public class ApiClient
    {
        ...
        private const string baseUrl = "http://dev-commercial-api.azurewebsites.net/api";

        public static string BuildInventoryUrl(int page, int quantity)
        {            
            string requestId = GetRequestId();

            string hash = HashGenerator.CreateSHA256(string.Format("{0}{1}{2}{3}", clientId, page, quantity, requestId));
